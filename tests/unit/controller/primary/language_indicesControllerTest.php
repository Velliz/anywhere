...
class language_indicesControllerTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->name = "language_indices";
    }

    public function testCreate()
    {
        // 3. modify the url if customized
        $url = "language_indices/create";
